function [x,flag,relres,iter,resvec,lsvec] = mylsqr(A,b,tol,maxit,M1,M2,x0,varargin)
%LSQR   LSQR Method.
% mylsqr: modified lsqr to output intermediate results
%
...
%%%%%%%% PIM
if nargout < 2 % only if no output is specified
    fprintf('iter residue\n');
end
    %%%%%%%%
for ii = 1 : maxit
    if existM1
